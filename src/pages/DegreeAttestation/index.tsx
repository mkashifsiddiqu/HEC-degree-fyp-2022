...
const DegreeAttestation = () => {
 ...
 //===================================Applicatin Creation ===================//
  ...
  const getExistApplication = async () => {
    ...
    if (response) {
      ...
      if (Application.length <=0) {
        ...
        ExistApphandleOpen() //To Show Your Application is Saved
  ...
  //==================================Model For Application Exist ===================
  const [ExistApp, setExistApp] = React.useState(false);
	const ExistApphandleOpen = () => setExistApp(true);
	const ExistApphandleClose = () => setExistApp(false);
 ...
 const  data={ApplicationId,applicationStatus:`submit`}
  ...
  return (
    ...
    >
        ...
        >
          <Box>
            ...
            >
              ...
              ></InfoIcon>
              Reference Number: HEC/&amp;A/DAS/2022/{ApplicationId}
            </Typography>
          </Box>
          <Box>
            ...
            <React.Fragment>
              ...
              {activeStep == 2 && (
                <Grid container spacing={1} sx={{ mt: 2, mb: 2 }} display="flex" justifyContent="flex-end">
                  <Grid item>
                    <Button size="medium" className={classes.tab_4btn}>
                      Save&Close
                    </Button>
                  </Grid>
                  <Grid item>
      ...
      <ModelOfApplication  
      ExistApp={ExistApp} ExistApphandleClose={ExistApphandleClose}/>
    </motion.div>
  );
};
