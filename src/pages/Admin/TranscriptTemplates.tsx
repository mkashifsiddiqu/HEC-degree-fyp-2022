...
const Degreetemplate = () => {
  ...
  return (
    <div>
      <Box margin={`0 3em`} >
        <Typography fontFamily={`montserrat`} fontSize={`1rem`} color={`#0000008a`} fontWeight={600}>New Request to Verify Transcript Template</Typography>
        ...
        <Table>
            ...
            {TemplateList.map((newRequestData)=>(
                ...
                <TableRow key={newRequestData._id}>
                   ...
                   <TableCell>
                        <Tooltip title='View'><IconButton color='primary'><Visibility/></IconButton></Tooltip>
                        <Tooltip title='Verify'><IconButton color='success'><CheckIcon/></IconButton></Tooltip>
                        <Tooltip title='Reject'><IconButton><CloseIcon color='error'/></IconButton></Tooltip>
                    </TableCell>
                </TableRow>
                    ...
                    open={open}
                            ...
                            sx={{display:`flex`,justifyContent:`center`,alignItems:`center`}}
                              >
                                ...
                                <img src={`/api/degree/preveiwImage/${imagePreview}`}
                                      alt={`degreeTemplate`}
                                  />
       ...
       <Typography margin={`1em 0`} fontFamily={`montserrat`} fontSize={`1rem`} color={`#0000008a`} fontWeight={600}>Verified Transcript Template</Typography>
        ...
        <TableBody>
          {TemplateList.map((row) => (
            ...
            >
              ...
              <Tooltip title='View'><IconButton color='primary'>
